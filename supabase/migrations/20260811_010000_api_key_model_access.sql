...
-- NULL allowed_models preserves the existing unrestricted behavior. An empty
-- array permits no models. sponsored_models never changes provider-cost
...
COMMENT ON COLUMN public.api_keys.allowed_models IS
    'Optional canonical provider:model allowlist. NULL means unrestricted.';
