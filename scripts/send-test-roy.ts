...
async function main() {
  const email = 'royadebanjo@gmail.com';
  ...
  const SNIP = 'https://cencori.com/snip.svg';
...
<img src="${SNIP}" width="550" height="154" alt="" style="display:block;width:100%;height:auto;max-width:550px;margin:24px 0;border-radius:6px;">
...
<p style="margin:0 0 4px;font-size:11px;color:#aaa;text-align:center;"><a href="https://cencori.com/account/settings" style="color:#888;text-decoration:underline;">Manage preferences</a> &nbsp;·&nbsp; <a href="https://cencori.com/unsubscribe" style="color:#888;text-decoration:underline;">Unsubscribe</a></p>
