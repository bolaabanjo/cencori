  ...
  const onValidate = async () => {
    ...
    try {
      ...
      if (res.ok && data.hasActivity) {
        ...
        router.push(`/dashboard/organizations/${orgSlug}/projects/${project.slug}`);
        return;
      }
                ...
                <CodeStep number="1" title="Send a request" copied={copiedRequest} onCopy={() => copyText(
                  ...
                  {activeLang === "typescript" && (
                    <>
                      ...
                      <code className="block text-[11px] font-mono">  <span className="text-zinc-300">model:</span> <span className="text-emerald-400">&quot;gpt-4o&quot;</span><span className="text-zinc-300">,</span></code>
