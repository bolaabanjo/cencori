      ...
      <section className="dark:bg-zinc-950">
        ...
        {step === 3 && (
          <div>
            ...
            <div className="grid gap-3 grid-cols-1 sm:grid-cols-2 rounded-3xl">
    ...
    >
      <div className="flex items-start justify-between rounded-full">
        ...
        <RadioGroup className="ml-4">
          <Label className={`h-5 w-5 border ${checked ? "bg-black dark:bg-white border-zinc" : "border-zinc-300 dark:border-zinc-100"}`} aria-hidden />
        </RadioGroup>
      </div>
    </RadioGroup>
  );
