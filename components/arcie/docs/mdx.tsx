...
function ArcieLink({ href = "#", className, ...props }: ComponentProps<"a">) {
...
// Lean, arcie-branded MDX map. Syntax highlighting, the mono font, and line
