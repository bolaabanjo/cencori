...
| `description` | What this agent is for. **Required for [subagents](/eline/docs/subagents)** so the orchestrator knows when to delegate. |
...
[Cencori integration](/eline/docs/cencori) for the full picture.
