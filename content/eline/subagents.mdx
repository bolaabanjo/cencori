...
for a [skill](/eline/docs/skills) instead of a subagent.
...
Each delegation emits two control-plane [events](/eline/docs/events) in the parent's
stream:
...
instructions and tools — `eline build` lists them under `subagents` in the manifest.
