...
import { defineSkill } from "eline/skills";
...
```ts
import { getSkill } from "eline/skills";
...
**Directory naming.** The loader and `eline dev` / `eline build` read skills from
...
- A **[tool](/eline/docs/tools)** executes code and returns a result.
- A **[subagent](/eline/docs/subagents)** is a separate agent you delegate a whole
