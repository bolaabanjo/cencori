...
This guide walks you through setting up Monetization from scratch. By the end, you'll have rate plans, markup pricing, and Stripe payments — all managed from the Cencori dashboard.
...
4. Toggle **Enable Monetization** to on.
...
Your engineers add two API calls — one before processing (quota check) and one after (usage report). See the [Monetization API Reference](/docs/platform/monetization#option-2-usage-events-api) for the full integration guide.
...
- [Monetization API Reference](/docs/platform/monetization) — technical documentation for your engineering team
