...
Monetization lets you charge your customers for AI usage. Set per-user rate plans with token/request limits, apply markup, and collect payments through Stripe Connect — all from the dashboard.

> [!NOTE]
> New to Monetization? Start with the [Setup Guide](/docs/guides/monetization-setup) — a step-by-step walkthrough for non-technical users. This page is the API reference for your engineering team.
...
6. You view it all in the Monetization dashboard.
...
If you route AI requests through the Cencori gateway, Monetization works automatically. Just pass the user ID in your request:
...
Rate plans define per-user limits and pricing. Create them in the dashboard under **Monetization > Rate Plans**.
...
1. Open any project's **Monetization > Configuration** page.
...
The **Monetization** page has four tabs:
