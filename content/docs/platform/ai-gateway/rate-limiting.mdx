...
There are no tiered per-minute limits or burst allowances — all tiers share the same 60/min per-project window. Need more throughput? Add a second project.
