...
|----------|-------------|-----------|
| [Chat](/docs/api/chat) | Conversational AI with streaming | OpenAI, Anthropic, Google, xAI, Mistral, DeepSeek |
| [Images](/docs/api/images) | Image generation from text | OpenAI (GPT Image, DALL-E), Google (Imagen) |
| [Embeddings](/docs/api/embeddings) | Vector embeddings for RAG | OpenAI, Google, Cohere |
| [Audio](/docs/api/voice) | Speech-to-text and text-to-speech | OpenAI (Whisper, TTS) |
| [Moderation](/docs/api/moderation) | Content safety filtering | OpenAI |
