...
**Directory naming.** The loader and `arcie dev` / `arcie build` read skills from
...
- A **[tool](/arcie/docs/tools)** executes code and returns a result.
- A **[subagent](/arcie/docs/subagents)** is a separate agent you delegate a whole
